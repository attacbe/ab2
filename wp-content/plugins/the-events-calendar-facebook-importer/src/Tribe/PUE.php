<?php
/**
 * Manage upgrades for the Tribe Events Facebook Importer plugin
 *
...
if ( ! class_exists( 'Tribe__Events__Facebook__PUE' ) ) {
	class Tribe__Events__Facebook__PUE {

		/**
		 * @var string slug used for the plugin update engine
		 */
		private static $pue_slug = 'events-facebook-importer';
